...
#########
TEST_NAME="CreateConsumableUnauthed"
SHOULD_STATUS="401"
...
RESPONSE=$(curl -s -o "$OUTPUT_FILE" -w "%{http_code}" --location --request POST http://localhost:8080/de/consumables \
